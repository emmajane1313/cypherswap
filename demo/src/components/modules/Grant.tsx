...
const Grant: FunctionComponent<GrantProps> = ({
  ...
  return (
    <div className="relative w-full h-full flex flex-col items-center justify-center rounded-lg border border-agua p-4 gap-6">
      ...
      <div className="relative w-full h-full flex flex-col border border-white rounded-lg p-1.5">
        <textarea
          className="relative w-full h-44 flex items-center justify-center text-xs font-dog text-white rounded-lg bg-black"
      ...
      <div className="relative w-full h-[15.5rem] flex flex-row items-center justify-center p-2 gap-4">
        <div className="relative w-full h-full flex flex-col border border-white rounded-lg p-1.5 gap-2">
          ...
          <textarea
            className="relative w-full h-full flex items-center justify-center text-xs font-dog text-white rounded-lg bg-black"
